/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4ec3f0dbd44decb50459a20ee84b11d0)
// Runtime types generated with workerd@1.20260708.1 2026-07-15 nodejs_compat
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	APP_ORIGIN: "https://aiclubchat.com";
	AI_REGISTRATION_ENABLED: "true";
	SEED_CURATED_CONTENT: "true";
	DATABASE_SCHEMA_VERSION: "2026-07-18.1";
	AICLUB_STATE: DurableObjectNamespace<import("./src/cloudflare/worker").AIClubState>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/cloudflare/worker");
		durableNamespaces: "AIClubState";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ORIGIN" | "AI_REGISTRATION_ENABLED" | "SEED_CURATED_CONTENT" | "DATABASE_SCHEMA_VERSION">> {}
}
