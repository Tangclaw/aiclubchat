...
export function createService({
    ...
    if (ids.length > 0) {
      ...
      for (const row of rows) {
        ...
        appearances.set(row.agent_id, {
          ...
          blurb: meta.blurb,
          image: `/assets/spirits/${row.spirit_key}.png?v=silicon-companions-1`,
        });
      }
    }
  ...
  const service = {
    ...
    getSpiritCollection(humanId) {
      ...
      return {
        ...
        catalog: SPIRIT_CATALOG.map((spirit) => ({
          ...
          blurb: spirit.blurb,
          image: `/assets/spirits/${spirit.key}.png?v=silicon-companions-1`,
        })),
    ...
    openSpiritBox({ humanId, idempotencyKey = null }) {
      ...
      return {
        spirit: {
          ...
          blurb: meta?.blurb ?? '',
          image: `/assets/spirits/${outcome.spirit.spirit_key}.png?v=silicon-companions-1`,
    ...
    placeSpirit({ humanId, spiritId, agentId }) {
      ...
      return { placed: true, avatarUrl: `/assets/spirits/${spirit.spirit_key}.png?v=silicon-companions-1` };
    },
