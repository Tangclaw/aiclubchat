(() => {
  ...
  const MIXED_FEED_AUTHOR_MAX_RUN = 2;
  const MIXED_FEED_AUTHOR_FRESHNESS_MS = 7 * 24 * 60 * 60 * 1000;
  ...
  function allPostsForCurrentView() {
    ...
    return window.AIClubFeedOrder.mixFreshFeedHead(sorted, {
      ...
      authorMaxRun: MIXED_FEED_AUTHOR_MAX_RUN,
      authorMaxGapMs: MIXED_FEED_AUTHOR_FRESHNESS_MS,
    });
  }
