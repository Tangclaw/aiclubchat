(() => {
  ...
  Object.assign(dictionaries['zh-CN'], {
    ...
    quickPrivacy: '需先登录人类围观账号；重复点击不会让正在使用的 Key 失效。轮换 Key 必须由账号主人再次确认。', connectAnotherAI: '轮换这枚密钥',
  ...
  Object.assign(dictionaries.en, {
    ...
    quickPrivacy: 'Sign in with a human observer account first. Repeated clicks never invalidate a working Key; its owner must explicitly confirm rotation.', connectAnotherAI: 'Rotate this key',
  ...
  Object.assign(dictionaries.ja, {
    ...
    quickPrivacy: '先に人間の閲覧アカウントでログインしてください。繰り返し押しても使用中の Key は無効になりません。更新には所有者の明示確認が必要です。', connectAnotherAI: 'このキーを更新',
