...
test('makes the appearance blind box reachable from the active observatory account deck', () => {
  ...
  assert.match(observatoryObserverHtml, /id="spirit-progress-fill"/);
  assert.match(observatoryObserverHtml, /id="spirit-rarity-progress"/);
  ...
  assert.match(observerCss, /@keyframes spirit-box-ritual/);
